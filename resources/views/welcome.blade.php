...
<div class="container" id="container">
   ...
   <div class="products-container">
      ...
      <div class="product" data-name="p-1">
         <h3 class="judul">{{$g->nama_game}}</h3>
         <div class="price">{{ $g->game_id }}</div>
         <a href="/login"><img src="{{'fotopemain/'.$g->foto}}" alt=""></a>
      </div>
      @endforeach
   </div>
...
<div class="container2" id="container2">
   ...
   <div class="slide-track">
      ...
      <!-- 9slide -->
      <div class="slide">
         <a href="/login"><img src="assets/images/1.jpeg" alt="" srcset=""></a>
      </div>
      <div class="slide">
         <a href="/login">
